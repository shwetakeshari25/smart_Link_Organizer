      ...
      <div className="p-6 glass-panel rounded-3xl border-slate-200/50 dark:border-slate-800/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="p-3 card-sky-blue rounded-2xl shadow-sm">
            <span className="block text-lg font-black text-[#3D352E] heading-font">+10 XP</span>
            <span className="text-[10px] text-[#3D352E]/85 font-extrabold uppercase tracking-wider">Save a Link</span>
          </div>

          <div className="p-3 card-mint-green rounded-2xl shadow-sm">
            <span className="block text-lg font-black text-[#3D352E] heading-font">+20 XP</span>
            <span className="text-[10px] text-[#3D352E]/85 font-extrabold uppercase tracking-wider">Complete Link</span>
          </div>
          ...
          <div className="p-3 card-baby-pink rounded-2xl shadow-sm">
            <span className="block text-lg font-black text-[#3D352E] heading-font">+2 XP</span>
            <span className="text-[10px] text-[#3D352E]/85 font-extrabold uppercase tracking-wider">Favorite Link</span>
          </div>
        </div>
      </div>
