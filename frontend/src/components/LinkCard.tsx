...
export const LinkCard: React.FC<LinkCardProps> = ({ link, onUpdate, onDelete, onOpen, hasGoldTheme, onSolveVideoQuiz }) => {
  ...
  const getPlatformGradient = (platform: string) => {
    switch (platform) {
      ...
      case 'Facebook': return 'from-[#CCA25A] to-[#5136E0]';
      ...
      default: return 'from-[#CCA25A] to-[#34BEA9]';
    }
  };
  ...
  const getPlatformBg = (platform: string) => {
    switch (platform) {
      ...
      case 'GitHub': return 'bg-[#F5F5FC] border-[#CBBD93]/20';
      ...
      case 'Facebook': return 'bg-[#F3E8FF] border-[#CCA25A]/20';
      case 'Reddit': return 'bg-[#FFF7F0] border-[#F8C79A]/30';
      case 'Medium': return 'bg-[#F0FFF9] border-[#7EE7C4]/30';
      case 'Dev.to': return 'bg-[#F7F2FF] border-[#FFB16E]/30';
