...
export const AnalyticsView: React.FC<AnalyticsViewProps> = ({ links }) => {
  ...
  const COLORS = ['#2563EB', '#14B8A6', '#EAD2C3', '#22C55E', '#F59E0B', '#EF4444', '#EC4899', '#64748B'];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-5 card-sky-blue rounded-3xl border border-[#D4C5B9]/20 flex items-center gap-4 shadow-sm">
          <div className="p-3 bg-white/30 rounded-2xl text-[#3D352E]">
            <FileText className="w-5 h-5" />
          </div>
          <div>
            <span className="block text-xl font-black text-[#3D352E] heading-font">{totalLinks}</span>
            <span className="text-[10px] uppercase font-bold text-[#3D352E]/80 tracking-wider">Total Links</span>
          </div>
        </div>
        ...
        <div className="p-5 card-mint-green rounded-3xl border border-[#7EE7C4]/20 flex items-center gap-4 shadow-sm">
          ...
          <div>
            <span className="block text-xl font-black text-[#3D352E] heading-font">{completionRate}%</span>
            <span className="text-[10px] uppercase font-bold text-[#3D352E]/80 tracking-wider">Completion Rate</span>
          </div>
        </div>
        ...
        <div className="p-5 card-peach rounded-3xl border border-[#F8C79A]/20 flex items-center gap-4 shadow-sm">
          ...
          <div>
            <span className="block text-xl font-black text-[#3D352E] heading-font">{watchingLinks}</span>
            <span className="text-[10px] uppercase font-bold text-[#3D352E]/80 tracking-wider">In Progress</span>
          </div>
        </div>
        ...
        <div className="p-5 card-baby-pink rounded-3xl border border-[#F8B4D9]/20 flex items-center gap-4 shadow-sm">
          ...
          <div>
            <span className="block text-xl font-black text-[#3D352E] heading-font">{uniqueTagsCount}</span>
            <span className="text-[10px] uppercase font-bold text-[#3D352E]/80 tracking-wider">Unique Tags</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 bg-gradient-to-br from-white/95 to-[#D7C4B7]/10 border border-[#D7C4B7]/30 rounded-3xl shadow-lg">
          <h3 className="heading-font text-base font-bold text-[#3D352E] mb-4 flex items-center gap-2">
            <Activity className="w-4 h-4 text-[#A38F85]" /> Weekly Saving Activity
          </h3>
          <div className="h-64">
            {totalLinks === 0 ? (
        ...
        <div className="p-6 bg-gradient-to-br from-white/95 to-[#D4C5B9]/10 border border-[#D4C5B9]/30 rounded-3xl shadow-lg">
          <h3 className="heading-font text-base font-bold text-[#3D352E] mb-4 flex items-center gap-2">
            <PieChartIcon className="w-4 h-4 text-[#A38F85]" /> Platform Share
          </h3>
