    ...
    <div className="min-h-screen flex text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-[#0B0F19]">
      ...
      <aside className={`fixed lg:sticky top-0 left-0 h-screen z-40 w-64 sidebar-navy flex flex-col justify-between transition-transform duration-300 lg:translate-x-0 ${
        ...
        <div className="p-5 border-t border-slate-200/50 dark:border-slate-800/20">
          <div className="p-4 bg-gradient-to-tr from-[#A38F85]/10 to-[#34BEA9]/10 rounded-2xl border border-[#A38F85]/10 flex items-center gap-3">
            <div className="p-2 bg-[#A38F85]/10 rounded-xl text-[#A38F85] shrink-0">
                ...
                <div className="space-y-6">
                  ...
                  {filteredLinks.length === 0 ? (
                    <div className="p-16 bg-gradient-to-br from-[#FAF6FA] to-[#DEAB90]/15 border border-[#DEAB90]/30 rounded-3xl text-center shadow-lg">
                      ...
                      <h3 className="text-base font-bold text-[#3D352E] heading-font">No favorites saved</h3>
